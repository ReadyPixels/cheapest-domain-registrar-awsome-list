...
To add something to this list, please:

- Make sure the addition is actually awesome and provides real value to someone looking for cheap domain registrars.
- Search previous pull requests before making a new one to avoid duplicates.
